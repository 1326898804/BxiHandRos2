...
def generate_launch_description():
    ...
    # Hardware node (installed as console script via aero_hand_open.setup.py)
    aero_hand_node = Node(
    ...
    # Run the rviz_joint_bridge script directly from the package scripts directory.
    # Using ExecuteProcess to ensure the script runs even if not installed as a console script.
    rviz_joint_bridge_proc = ExecuteProcess(
        cmd=["python3", str(pkg_path / "scripts" / "rviz_joint_bridge.py")],
        output="screen",
    )
